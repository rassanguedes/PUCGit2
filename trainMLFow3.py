...
def config_mlflow():
    ...
    Returns:
        None
    """
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'rassanguedes'   
    os.environ['MLFLOW_TRACKING_PASSWORD'] = '571c5add6ae33ad78fd731622b601eb10b0ab2e6'
    mlflow.set_tracking_uri('https://dagshub.com/rassanguedes/Repo1PUC.mlflow')
